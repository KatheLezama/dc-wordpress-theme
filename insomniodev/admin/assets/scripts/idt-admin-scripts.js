	...
	function getSettingsValues( section = '' ) {
		...
		switch ( section ) {
			case 'logos':
				...
				var logoStickyId = logosContainer.find( '#idt-logo-sticky-id' ).val();
				var logoStickyUrl = logosContainer.find( '#idt-logo-sticky-url' ).val();

				var logoMobileId = logosContainer.find( '#idt-logo-mobile-id' ).val();
				var logoMobileUrl = logosContainer.find( '#idt-logo-mobile-url' ).val();
				...
				values = {
					...
					settings: {
						...
						sticky: [
							parseInt( logoStickyId ),
							logoStickyUrl
						],
						mobile: [
							parseInt( logoMobileId ),
							logoMobileUrl
						]
					}
				};
			...
			case 'menu':
				...
				var dropdown = menuContainer.find( '#idt-check-drop-down-mobile' ).is(":checked");
				var desktop = menuContainer.find( '#idt-check-menu-desktop' ).is(":checked");
				var top = menuContainer.find( '#idt-check-menu-top' ).is(":checked");
				var search = menuContainer.find( '#idt-check-menu-search' ).is(":checked");
